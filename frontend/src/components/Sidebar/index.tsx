...
export function Sidebar() {
  ...
  return (
    <SidebarContainer>
      ...
      {/* Menu Principal (Fica no topo e empurra o resto pra baixo) */}
      <TopNav>
      ...
      <UserProfile>
        {/* Usamos as iniciais do nome como foto de perfil genérica */}
        <Avatar>PF</Avatar> 
        <UserInfo>
